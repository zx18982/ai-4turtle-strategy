...
# 👉 **https://zx18982.github.io/ai-4turtle-strategy/**

> **注意**：本页面是 GitHub 仓库说明页，**不是工具本身**。工具在上面的链接，是一个完整的前端 Web 应用。
...
> 数据区间：约 2 年日线（前复权），截至 2026-07-24，每支 480 个交易日。

## 📂 目录结构

```
task04_turtle_strategy/
  web_tool/              # 前端应用（GitHub Pages 部署此目录）
    index.html           # 入口页面
    css/style.css        # 样式
    js/
      data.js            # 股价数据（自动生成）
  ...
  .github/workflows/
    ...
    deploy-pages.yml     # GitHub Action：自动部署到 Pages
```
