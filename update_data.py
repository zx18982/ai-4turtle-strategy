...
STOCKS = [
    ...
    ("300433", "sz300433", "蓝思科技", "电子制造"),
    ("300308", "sz300308", "中际旭创", "通信设备"),
    ("601200", "sh601200", "上海环境", "环保"),
    ("600649", "sh600649", "城投控股", "房地产"),
    ("600109", "sh600109", "国金证券", "证券"),
    ("601169", "sh601169", "北京银行", "银行"),
    ("600177", "sh600177", "雅戈尔",   "纺织服装"),
    ("600021", "sh600021", "上海电力", "电力"),
]
